                            ...
                            if (empty( $admin_name)||empty( $email)||empty( $username)||empty( $password)||empty( $role_id)) {
                              echo "<div class='alert alert-warning'>
                                 ...
                                 if ($result&&$delmsg) {
                                     ...
                                     $admin_email="farhana.kucse@gmail.com";
                 ...
                 <?php 
                  ...
                  ?>
                        <tr>
                            <td>Name:</td>
                            <td>
                            <input type="text" name="name" readonly="readonly" value="<?php echo $result['fname']." ".$result['lname'];?>"/>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>Email Address:</td>
                            <td>
                            <input type="email" readonly="readonly" name="email" value="<?php echo $result['email'];?>"/>
                            </td>
                        </tr>	
                        <?php }}}?>				
                        <tr>
