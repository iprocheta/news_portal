                ...
                <div class="block">        
					...
					?>
						<tr class="odd gradeX">
							...
							<td><a href="editcat.php?catid=<?php echo $result['cat_id'];?>">Edit</a> || <a onclick="return confirm('Are you Sure to Delete!');" href="?catid=<?php echo $result['cat_id'];?>">Delete</a></td>
						</tr>
					<?php
							$i++;
							}
