        ...
        <div class="grid_10">
            <div class="box round first grid">
                ...
                <div class="block">  
					...
					<tbody>
					<?php
						$query="SELECT * ,tbl_category.cat_name,tbl_post.id as postid,tbl_admins.admin_name
						FROM tbl_post 
					...
					?>
						<tr class="odd gradeX">
							...
							<td><a href="editpost.php?editpostid=<?php echo $result['postid'];?>">Edit</a> || <a onclick="return confirm('Are you Sure to Delete!');" href="?delpostid=<?php echo $result['postid'];?>">Delete</a></td>
						</tr>
						<?php 
								$i++;
							}
